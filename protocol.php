...
function fetchAndCacheProtocolData($cacheFile, $startDate, $endDate = 'today', $ttl = 45)
{
...
$resultsToday     = fetchAndCacheProtocolData($protocolFileToday, 'today', 'today', 45);
$resultsYesterday = fetchAndCacheProtocolData($protocolFileYesterday, 'yesterday', 'today', 3600);
$results7Days     = fetchAndCacheProtocolData($protocolFile7Days, '7daysAgo', 'today', 3600);
$results30Days    = fetchAndCacheProtocolData($protocolFile30Days, '30daysAgo', 'today', 3600);
?>
