    ...
    <div class="container p-4">
        <ul class="list-inline d-flex justify-content-center">
            <li class="list-inline-item">
                <a href="https://www.spcast.eu/kontakt/impressum/" target="_blank" rel="noopener" class="text-dark text-decoration-none"><?php



echo htmlspecialchars(__('Imprint')); ?></a> |
            </li>
            <li class="list-inline-item">
...
?>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        &copy; <?php echo date("Y"); ?> SPCast.eu
    </div>
</footer>
