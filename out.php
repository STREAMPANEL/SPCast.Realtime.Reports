...
$cacheDir    = 'cache/';
$cacheFile   = $cacheDir . 'analytics_cache_out.json';
$historyFile = $cacheDir . 'analytics_history_out.json';
$weeklyFile  = $cacheDir . 'analytics_weekly_out.json';
$monthlyFile = $cacheDir . 'analytics_monthly_out.json';
$cacheTime   = 45;
...
function fetchAndCacheData()
{
    ...
    $service   = new AnalyticsService($analytics);
    $response  = $service->getRealTimeReport('properties/457889788');
...
function fetchAndCacheWeeklyData()
{
    ...
    $analytics = initializeAnalytics();
    $service   = new AnalyticsService($analytics);
    $response  = $service->getWeeklyReport('properties/457889788');
...
function fetchAndCacheMonthlyData()
{
    ...
    $analytics = initializeAnalytics();
    $service   = new AnalyticsService($analytics);
    $response  = $service->getMonthlyReport('properties/457889788');
...
<head>
    ...
    <title>Ausgehende Nutzerstatistik - SPCast Live</title>
    <meta name="description" content="Zeigt die Nutzer, die Sender im Netzwerk innerhalb der letzten 30 Minuten ausgeschaltet haben. Echtzeit- und Live-Daten verfügbar.">
    <meta name="keywords" content="spcast live, spcast nutzerstatistik, ausgehende nutzer, sender ausschalten, echtzeitdaten, netzwerkaktivitäten">
    <link rel="canonical" href="https://live.spcast.eu/out.php" />
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card text-center">
                    <div class="card-body">
                        <h3 class="card-title">
                            Ausgeschaltet in den letzten 30 Minuten
                        </h3>
                        <small>Nutzer, die in den letzten 30 Minuten einen Sender ausgeschaltet haben.</small>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Ausgeschaltet pro 30 Minuten',
                        data: chartData,
                ...
                options: {
                    scales: {
                        ...
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Ausgeschaltet pro 30 Minuten'
                            }
                        }
                    }
                }
            ...
            const weeklyChart = new Chart(ctxWeekly, {
                ...
                data: {
                    labels: weeklyDates,
                    datasets: [{
                        label: 'Ausgeschaltet in den letzten 7 Tagen',
            ...
            const monthlyChart = new Chart(ctxMonthly, {
                ...
                data: {
                    labels: monthlyDates,
                    datasets: [{
                        label: 'Ausgeschaltet in den letzten 30 Tagen',
