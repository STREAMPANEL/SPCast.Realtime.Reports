...
function fetchAndCacheData()
{
    ...
    $response  = $service->getRealTimeReport('properties/457854648');
...
function fetchAndCacheWeeklyData()
{
    ...
    $analytics = initializeAnalytics();
    $service   = new AnalyticsService($analytics);
    $response  = $service->getWeeklyReport('properties/457854648');
...
function fetchAndCacheMonthlyData()
{
    ...
    $analytics = initializeAnalytics();
    $service   = new AnalyticsService($analytics);
    $response  = $service->getMonthlyReport('properties/457854648');
