...
$cacheDir    = 'cache/';
$cacheFile   = $cacheDir . 'analytics_cache_all.json';
$historyFile = $cacheDir . 'analytics_history_all.json';
$weeklyFile  = $cacheDir . 'analytics_weekly_all.json';
$monthlyFile = $cacheDir . 'analytics_monthly_all.json';
$cacheTime   = 45;
...
function getRealTimeReport($analytics)
{
    ...
    return $analytics->properties->runRealtimeReport('properties/453756722', $body);
}
...
<head>
    ...
    <title>Alle Nutzeraktivitäten - SPCast Live</title>
    <meta name="description" content="Zeigt alle Nutzer, die Sender im Netzwerk ein- oder ausgeschaltet haben. Echtzeitdaten, aktualisiert alle 30 Minuten.">
    <meta name="keywords" content="spcast live, spcast nutzeraktivitäten, sender ein- und ausschalten, echtzeitdaten, netzwerkstatistiken, gesamtübersicht">
    <link rel="canonical" href="https://live.spcast.eu/all.php" />
                    ...
                    <div class="card-body">
                        <h3 class="card-title">
                            ...
                            <i class="bi bi-info-circle info-icon" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Es handelt sich um Nutzer, die in den letzten 30 Minuten einen Sender im Netzwerk eingeschaltet oder ausgeschaltet haben, nicht um die aktiven Zuhörer der gesamten Plattform."></i>
                        </h3>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Aktive Nutzer pro 30 Minuten',
                        data: chartData,
                ...
                options: {
                    scales: {
                        ...
                        y: {
                            ...
                            title: {
                                display: true,
                                text: 'Aktive Nutzer pro 30 Minuten'
                            }
                        }
                    }
                }
            ...
            const weeklyChart = new Chart(ctxWeekly, {
                ...
                data: {
                    labels: weeklyDates,
                    datasets: [{
                        label: 'Aktive Nutzer in den letzten 7 Tagen',
            ...
            const monthlyChart = new Chart(ctxMonthly, {
                ...
                data: {
                    labels: monthlyDates,
                    datasets: [{
                        label: 'Aktive Nutzer in den letzten 30 Tagen',
